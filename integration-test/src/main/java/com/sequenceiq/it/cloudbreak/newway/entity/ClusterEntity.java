...
import com.sequenceiq.it.cloudbreak.newway.gherkin.Gherkin;
...
public class ClusterEntity extends AbstractCloudbreakEntity<ClusterV2Request, ClusterResponse, ClusterEntity> {
    ...
    public static ClusterEntity withBluepintNameAndClusterName(String blueprintName, String clusterName) {
        return Gherkin.given(ClusterEntity.class)
                .withAmbariRequest(Gherkin.given(AmbariEntity.class).withBlueprintName(blueprintName))
